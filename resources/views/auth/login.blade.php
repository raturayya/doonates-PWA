...
@section('content')
<div x-data="{ isLogin: true }" class="min-h-screen bg-gradient-to-br from-green-50 via-white to-green-50 flex">
            ...
            <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
                ...
                <form method="POST" action="{{ route('login') }}" x-show="isLogin" class="space-y-5">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <a href="#" class="text-sm text-[#2E7D32] hover:underline">Forgot password?</a>
                    </div>
                ...
                <!-- Register Form -->
                <form method="POST" action="{{ route('register') }}" x-show="!isLogin" class="space-y-5" style="display: none;">
                    @csrf
                    ...
                    <div>
                        <label class="block text-gray-700 mb-2">Organization Type</label>
                        <select
                    ...
                    <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                        <p class="text-sm text-blue-800">
                            ...
                            Account requires admin verification before activation
                        </p>
                    </div>
